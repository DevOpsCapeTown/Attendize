...
return [
    ...
    'checkout_timeout_after' => env('CHECKOUT_TIMEOUT_AFTER', 20), #minutes
    ...
    'default_locale'             => 'en',
    'default_payment_gateway'    => 5, #Stripe=1 Paypal=2 BitPay=3 MIGS=4 PayFast=5
